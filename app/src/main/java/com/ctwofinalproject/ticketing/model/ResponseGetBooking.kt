...
data class PassangerBookingItemGetBooking(
	...
	val passanger: PassangerGetBooking? = null,
...
@Parcelize
data class PlaneNameGetBooking(
...
data class DataItemGetBooking(
	...
	val usersPayment: UsersPaymentGetBooking? = null,
...
@Parcelize
data class UsersPaymentGetBooking(
...
data class FlightGetBooking(
	...
	val planeName: PlaneNameGetBooking? = null,
...
@Parcelize
data class PassangerGetBooking(
