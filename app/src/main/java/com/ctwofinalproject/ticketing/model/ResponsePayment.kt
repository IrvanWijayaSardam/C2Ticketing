...
data class BookingPayment(
	...
	val ticketReturn: @RawValue Any? = null,
...
data class PassangerPayment(
	...
	val identityType: @RawValue Any? = null,

	@field:SerializedName("identityNumber")
	val identityNumber: @RawValue Any? = null,
...
data class ArrivalTerminalPayment(
	...
	@field:SerializedName("terminal")
	val terminal: @RawValue Any? = null,
...
data class PassangerBookingItemPayment(
	...
	val passanger: PassangerPayment? = null,
...
data class PaymentMutual(
	...
	val usersPayment: UsersPaymentPayment? = null,
